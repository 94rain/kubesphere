...
KubeSphere 采用了前后端分离的架构设计，后端的各个功能组件可通过 REST API 对接外部系统，详见 [架构说明](https://kubesphere.com.cn/docs/zh/introduction/architecture/)。本仓库仅包含后端代码，前端代码参考 [Console 项目](https://github.com/kubesphere/console)。
...
以上功能说明详见 [产品功能](https://kubesphere.com.cn/docs/zh/introduction/features/)。

----

## 最新发布

KubeSphere 3.1.0 已于 2021 年 4 月 29 日正式 GA！点击 [Release Notes For 3.1.0](https://kubesphere.com.cn/docs/release/release-v300/) 查看 3.1.0 版本的更新详情。
